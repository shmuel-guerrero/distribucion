...
) ENGINE=MyISAM AUTO_INCREMENT=28169 DEFAULT CHARSET=utf8;
...
) ENGINE=MyISAM AUTO_INCREMENT=4998 DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `inv_productos` (
  ...
  KEY `categoria_id` (`categoria_id`),
  KEY `marca_id` (`marca_id`)
) ENGINE=MyISAM AUTO_INCREMENT=7785 DEFAULT CHARSET=utf8;
...
) ENGINE=MyISAM AUTO_INCREMENT=82839 DEFAULT CHARSET=utf8;
