-- --------------------------------------------------------
-- Host:                         95.216.181.83
-- Versión del servidor:         10.3.31-MariaDB-cll-lve - MariaDB Server
...
-- Volcando estructura para tabla distribuidhgc_test.backup_inv_egresos
...
-- Volcando estructura para tabla distribuidhgc_test.backup_inv_egresos_detalles
...
-- Volcando estructura para tabla distribuidhgc_test.backup_inv_ingresos
...
-- Volcando estructura para tabla distribuidhgc_test.backup_inv_ingresos_detalles
CREATE TABLE IF NOT EXISTS `backup_inv_ingresos_detalles` (
  ...
  `elaboracion` date DEFAULT '0000-00-00',
...
-- Volcando estructura para tabla distribuidhgc_test.backup_inv_pagos
...
-- Volcando estructura para tabla distribuidhgc_test.backup_inv_pagos_detalles
...
-- Volcando estructura para tabla distribuidhgc_test.backup_inv_productos
...
-- Volcando estructura para tabla distribuidhgc_test.backup_tmp_egresos
CREATE TABLE IF NOT EXISTS `backup_tmp_egresos` (
  ...
  `ruta_id` int(11) NOT NULL DEFAULT 0,
  `distribuidor_fecha` date NOT NULL DEFAULT '0000-00-00',
  ...
  `accion` enum('Entrega','Venta','VentaDevuelto','Noentrega','Anulado') NOT NULL DEFAULT 'Entrega',
  `delet_fecha_egreso` date NOT NULL,
  `delet_hora_egreso` time NOT NULL,
  `delet_empleado_id` int(11) NOT NULL,
...
-- Volcando estructura para tabla distribuidhgc_test.backup_tmp_egresos_detalles
...
-- Volcando estructura para tabla distribuidhgc_test.caj_movimientos
...
-- Volcando estructura para tabla distribuidhgc_test.con_asiento
...
-- Volcando estructura para tabla distribuidhgc_test.con_asientos_automaticos
...
-- Volcando estructura para tabla distribuidhgc_test.con_asientos_menus
...
-- Volcando estructura para tabla distribuidhgc_test.con_clasificacion
...
-- Volcando estructura para tabla distribuidhgc_test.con_comprobante
...
-- Volcando estructura para tabla distribuidhgc_test.con_cuenta
...
-- Volcando estructura para tabla distribuidhgc_test.con_datos_empresa
...
-- Volcando estructura para tabla distribuidhgc_test.con_detalles_automaticos
...
-- Volcando estructura para tabla distribuidhgc_test.con_factura
...
-- Volcando estructura para tabla distribuidhgc_test.con_menus
...
-- Volcando estructura para tabla distribuidhgc_test.con_plan
...
-- Volcando estructura para tabla distribuidhgc_test.con_tipo_moneda
...
-- Volcando estructura para tabla distribuidhgc_test.con_ufv
...
-- Volcando estructura para tabla distribuidhgc_test.cronograma
...
-- Volcando estructura para tabla distribuidhgc_test.cronograma_cuentas
...
-- Volcando estructura para tabla distribuidhgc_test.gps_asigna_distribucion
...
-- Volcando estructura para tabla distribuidhgc_test.gps_historial_asinacion
...
-- Volcando estructura para tabla distribuidhgc_test.gps_historial_distribuidores_vendedores
...
-- Volcando estructura para tabla distribuidhgc_test.gps_noventa_motivos
...
-- Volcando estructura para tabla distribuidhgc_test.gps_no_venta
...
-- Volcando estructura para tabla distribuidhgc_test.gps_rutas
...
-- Volcando estructura para tabla distribuidhgc_test.gps_seguimientos
...
-- Volcando estructura para tabla distribuidhgc_test.inv_almacenes
...
-- Volcando estructura para tabla distribuidhgc_test.inv_asignaciones
...
-- Volcando estructura para tabla distribuidhgc_test.inv_categorias
...
-- Volcando estructura para tabla distribuidhgc_test.inv_clientes
...
) ENGINE=MyISAM AUTO_INCREMENT=4991 DEFAULT CHARSET=utf8;

-- La exportación de datos fue deseleccionada.

-- Volcando estructura para tabla distribuidhgc_test.inv_clientes_grupos
...
-- Volcando estructura para tabla distribuidhgc_test.inv_control
...
-- Volcando estructura para tabla distribuidhgc_test.inv_control_detalle
...
-- Volcando estructura para tabla distribuidhgc_test.inv_detalle_ingreso_material
...
-- Volcando estructura para tabla distribuidhgc_test.inv_dosificaciones
...
-- Volcando estructura para tabla distribuidhgc_test.inv_egresos
...
-- Volcando estructura para tabla distribuidhgc_test.inv_egresos_anular
...
-- Volcando estructura para tabla distribuidhgc_test.inv_egresos_detalles
...
-- Volcando estructura para tabla distribuidhgc_test.inv_egresos_detalles_anular
...
-- Volcando estructura para tabla distribuidhgc_test.inv_egresos_detalles_editar_post
CREATE TABLE IF NOT EXISTS `inv_egresos_detalles_editar_post` (
  ...
  KEY `unidad_id` (`unidad_id`),
  KEY `egreso_id` (`egreso_id`),
  KEY `empleado_id_accionn` (`empleado_id_accion`) USING BTREE,
  FULLTEXT KEY `lote` (`lote`)
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8;

-- La exportación de datos fue deseleccionada.

-- Volcando estructura para tabla distribuidhgc_test.inv_egresos_detalles_editar_previo
...
-- Volcando estructura para tabla distribuidhgc_test.inv_egresos_detalles_eliminar_post
...
-- Volcando estructura para tabla distribuidhgc_test.inv_egresos_detalles_eliminar_previo
...
-- Volcando estructura para tabla distribuidhgc_test.inv_egresos_detalles_entregas
...
-- Volcando estructura para tabla distribuidhgc_test.inv_egresos_detalles_inicio
...
-- Volcando estructura para tabla distribuidhgc_test.inv_egresos_detalles_noentregas
...
-- Volcando estructura para tabla distribuidhgc_test.inv_egresos_detalles_noventas
...
-- Volcando estructura para tabla distribuidhgc_test.inv_egresos_editar_post
...
-- Volcando estructura para tabla distribuidhgc_test.inv_egresos_editar_previo
...
-- Volcando estructura para tabla distribuidhgc_test.inv_egresos_eliminar_post
...
-- Volcando estructura para tabla distribuidhgc_test.inv_egresos_eliminar_previo
...
-- Volcando estructura para tabla distribuidhgc_test.inv_egresos_entregas
...
-- Volcando estructura para tabla distribuidhgc_test.inv_egresos_inicio
...
-- Volcando estructura para tabla distribuidhgc_test.inv_egresos_noentregas
...
-- Volcando estructura para tabla distribuidhgc_test.inv_egresos_noventas
...
-- Volcando estructura para tabla distribuidhgc_test.inv_ingresos
...
-- Volcando estructura para tabla distribuidhgc_test.inv_ingresos_detalles
...
-- Volcando estructura para tabla distribuidhgc_test.inv_ingreso_material
...
-- Volcando estructura para tabla distribuidhgc_test.inv_marcas
...
-- Volcando estructura para tabla distribuidhgc_test.inv_materiales
...
-- Volcando estructura para tabla distribuidhgc_test.inv_materiales_stock
...
-- Volcando estructura para tabla distribuidhgc_test.inv_meta
...
-- Volcando estructura para tabla distribuidhgc_test.inv_metas_distribuidor
...
-- Volcando estructura para tabla distribuidhgc_test.inv_meta_categoria
...
-- Volcando estructura para tabla distribuidhgc_test.inv_meta_producto
...
-- Volcando estructura para tabla distribuidhgc_test.inv_monedas
...
-- Volcando estructura para tabla distribuidhgc_test.inv_ordenes_detalles
...
-- Volcando estructura para tabla distribuidhgc_test.inv_ordenes_salidas
...
-- Volcando estructura para tabla distribuidhgc_test.inv_pagos
...
-- Volcando estructura para tabla distribuidhgc_test.inv_pagos_detalles
...
-- Volcando estructura para tabla distribuidhgc_test.inv_participantes_promos
...
-- Volcando estructura para tabla distribuidhgc_test.inv_precios
...
-- Volcando estructura para tabla distribuidhgc_test.inv_prioridades_ventas
...
-- Volcando estructura para tabla distribuidhgc_test.inv_productos
...
-- Volcando estructura para tabla distribuidhgc_test.inv_proformas
CREATE TABLE IF NOT EXISTS `inv_proformas` (
  ...
  `estado` enum('Cotizado','Convertido') NOT NULL DEFAULT 'Cotizado',
...
-- Volcando estructura para tabla distribuidhgc_test.inv_proformas_detalles
...
-- Volcando estructura para tabla distribuidhgc_test.inv_promociones
...
-- Volcando estructura para tabla distribuidhgc_test.inv_promociones_monto
...
-- Volcando estructura para tabla distribuidhgc_test.inv_proveedores
...
-- Volcando estructura para tabla distribuidhgc_test.inv_requisitos_promo
...
-- Volcando estructura para tabla distribuidhgc_test.inv_terminales
...
-- Volcando estructura para tabla distribuidhgc_test.inv_tipos_clientes
...
-- Volcando estructura para tabla distribuidhgc_test.inv_unidades
...
-- Volcando estructura para tabla distribuidhgc_test.sys_empleados
...
-- Volcando estructura para tabla distribuidhgc_test.sys_instituciones
...
-- Volcando estructura para tabla distribuidhgc_test.sys_menus
...
-- Volcando estructura para tabla distribuidhgc_test.sys_permisos
...
-- Volcando estructura para tabla distribuidhgc_test.sys_planes
...
-- Volcando estructura para tabla distribuidhgc_test.sys_planes_atributos
...
-- Volcando estructura para tabla distribuidhgc_test.sys_planes_caracteristicas
...
-- Volcando estructura para tabla distribuidhgc_test.sys_planes_config
...
-- Volcando estructura para tabla distribuidhgc_test.sys_planes_config_detalles
...
-- Volcando estructura para tabla distribuidhgc_test.sys_planes_detalles
...
-- Volcando estructura para tabla distribuidhgc_test.sys_procesos
...
-- Volcando estructura para tabla distribuidhgc_test.sys_roles
...
-- Volcando estructura para tabla distribuidhgc_test.sys_users
...
-- Volcando estructura para tabla distribuidhgc_test.tmp_egresos
CREATE TABLE IF NOT EXISTS `tmp_egresos` (
  ...
  `factura` enum('Factura','Nota','Ninguno') DEFAULT 'Ninguno',
  `evento` enum('Ninguno','Devuelto') NOT NULL DEFAULT 'Ninguno',
  `accion` enum('Entrega','Venta','VentaDevuelto','Noentrega','Anulado','Devuelto','Eliminado') DEFAULT 'Entrega',
...
-- Volcando estructura para tabla distribuidhgc_test.tmp_egresos_detalles
...
-- Volcando estructura para tabla distribuidhgc_test.tmp_reposiciones
...
-- Volcando estructura para tabla distribuidhgc_test.tmp_reposiciones_detalles
