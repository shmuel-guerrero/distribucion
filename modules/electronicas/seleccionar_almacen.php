    	...
    	<div class="col-md-12">
    		<div class="panel panel-default">
    			...
    			<div class="panel-body">
    				...
    				<p class="text-right">
    					<a href="?/electronicas/mostrar" class="btn btn-warning">Mis ventas con factura</a>
    				</p>
    				<?php } ?>
    				...
    				$almacen = $db->from('inv_almacenes')->fetch();
    					...
    					?>
    					<div class="col-md-4">
    						<a class="seleccionarAlmacen" href="?/electronicas/crear/<?php echo $almacenX["id_almacen"]; ?>">
    							<div class="panel panel-default">
    							<div class="panel-heading">
