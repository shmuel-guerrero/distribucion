...
<div class="panel-body">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-5 col-md-6 text-right">
			...
			<a href="?/electronicas/crear" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span><span class="hidden-xs"> Vender</span></a>
			<?php } ?>
			...
			<a href="?/electronicas/mostrar" class="btn btn-primary"><i class="glyphicon glyphicon-list-alt"></i><span class="hidden-xs hidden-sm hidden-md"> Listado de mis ventas con factura</span></a>
			<?php } ?>
		</div>
	</div>
	<hr>
        ...
        <div id="print-area">
            ...
            <div class="row ">
	            ...
	            <div class="col-lg-6 col-md-6 col-sm-6">
					...
					<h4><strong>Número de autorizaci&oacute;n : </strong><?= escape($venta['nro_autorizacion']); ?></h4>
					<h4><strong>C&oacute;digo de control : </strong><?= escape($venta['codigo_control']); ?></h4>
	                ...
	                <h4><strong>Descuento : </strong><?= escape($venta['descuento_bs']); ?></h4>
	                <h4><strong>Total neto : </strong><?= escape($venta['monto_total_descuento']); ?></h4>
	                
	                <h4><strong>Forma de pago : </strong><?= ($venta['plan_de_pagos'] == 'si')?'A credito':'Pago completo' ?></h4>
							...
							<tfoot>
								...
								<?php if($venta['descuento_bs'] != 0){?>
									<tr class="active">
										...
										<th class="text-nowrap text-right"><?= number_format($venta['descuento_bs'], 2, '.', '').(isset($venta['descuento_porcentaje']) ? ' ('.$venta['descuento_porcentaje'].'%)' : ''); ?></th>										
									</tr>
									<tr class="active">
...
<div id="modal_cliente" class="modal fade">
	<div class="modal-dialog">
		<form method="POST" action="?/electronicas/editar" id="form_cliente" class="modal-content">
