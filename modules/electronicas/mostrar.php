...
// Obtiene las ventas
$ventas = $db->select('i.*, a.almacen, a.principal, e.nombres, e.paterno, e.materno')->from('inv_egresos i')->join('inv_almacenes a', 'i.almacen_id = a.id_almacen', 'left')->join('sys_empleados e', 'i.empleado_id = e.id_empleado', 'left')->where('i.empleado_id', $_user['persona_id'])->where('i.tipo', 'Venta')->where('i.codigo_control != ', '')->where('i.fecha_egreso >= ', $fecha_inicial)->where('i.fecha_egreso <= ', $fecha_final)->order_by('i.fecha_egreso desc, i.hora_egreso desc')->fetch();
...
<div class="panel-heading" data-formato="<?= strtoupper($formato_textual); ?>" data-mascara="<?= $formato_numeral; ?>" data-gestion="<?= date_decode($gestion_base, $_institution['formato']); ?>">
	<h3 class="panel-title">
		...
		<strong>Ventas electrónicas personales</strong>
	</h3>
</div>
<div class="panel-body">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-4 text-right">
			...
			<a href="?/electronicas/seleccionar_almacen" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span><span class="hidden-xs"> Crear venta con factura</span></a>
			<?php } ?>
		</div>
	</div>
	<hr>
	...
	<table id="table" class="table table-bordered table-condensed table-striped table-hover table-xs">
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-nowrap"><?= escape($venta['tipo'] . ' electrónica'); ?></td>
				...
				<td class="text-nowrap">
					<a href="?/electronicas/ver/<?= $venta['id_egreso']; ?>" data-toggle="tooltip" data-title="Ver detalle de venta"><i class="glyphicon glyphicon-list-alt"></i></a>
				</td>
				<?php } ?>
			</tr>
			<?php } ?>
...
$(function () {	
	...
	var table = $('#table').DataFilter({
		filter: true,
		name: 'ventas_electronicas_personales',
