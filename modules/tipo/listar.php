...
<div class="panel-body">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-4 text-right">
			...
			<a href="?/tipo/imprimir" target="_blank" class="btn btn-info">
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-nowrap">
					<?php if ($permiso_ver) { ?>
					<a href="?/tipo/ver/<?= $categoria['id_categoria']; ?>" data-toggle="tooltip" data-title="Ver categoría">
