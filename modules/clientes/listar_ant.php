...
$clientes = $db->query('SELECT a.cliente, a.imagen, a.nit, a.id_cliente, a.estado, a.telefono, a.direccion, a.tipo,  count(a.cliente) as nro_visitas FROM inv_clientes a LEFT OUTER JOIN inv_egresos b ON a.cliente = b.nombre_cliente ')->group_by('a.cliente, a.nit')->order_by('cliente asc, nit asc')->fetch();
