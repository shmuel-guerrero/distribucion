...
<div class="panel-body">
	...
	<div class="row">
        ...
        <div class="col-xs-12 col-sm-6 text-right">
            ...
            <a href="?/clientes/crear" class="btn btn-success"data-toggle="tooltip" data-placement="top" title="Nuevo Cliente (Alt+N)"><i class="glyphicon glyphicon-plus"></i><span class="hidden-xs"> Crear cliente</span></a>
...
<?php
    ...
    if(true){
?>
	<table id="table" class="table table-bordered table-condensed table-restructured table-striped table-hover" style="width:100%"> 
		<thead>
			<tr class="active">
