    				...
    				<!--<form id="formulario" class="form-horizontal" action="?/clientes/guardar_credito" method="POST">-->
    					<div style="zoom: 1;">
    						<div class="form-group">
    							...
    							<div class="col-sm-8">
                                    <input type="text" value="<?= $cliente['id_cliente']; ?>" name="codigo" id="codigo" class="form-control text-uppercase" autocomplete="off" data-validation="required number" readonly>
                                    <input type="hidden" value="<?= $cliente['id_cliente']; ?>" name="codigo" id="codigo">
    							</div>
    						</div>
    						<div class="form-group">
    							<label for="nit_ci" class="col-sm-4 control-label">NIT / CI:</label>
    							<div class="col-sm-8">
                                    <input type="text" value="<?= $cliente['nit']; ?>" name="nit_ci" id="nit_ci" class="form-control text-uppercase" autocomplete="off" data-validation="required number" readonly>
                                    <input type="hidden" value="<?= $cliente['id_cliente']; ?>" name="id_cliente" id="id_cliente">
    							</div>
    						</div>
                            <div class="form-group">
                                <label for="nombre_cliente" class="col-sm-4 control-label">Señor(es):</label>
                                <div class="col-sm-8">
                                    <input type="text" value="<?= $cliente['cliente']; ?>" name="nombre_cliente" id="nombre_cliente" class="form-control text-uppercase" autocomplete="off" data-validation="required letternumber length" data-validation-allowing="-+./&() " data-validation-length="max100" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="factura_cliente" class="col-sm-4 control-label">Nombre factura:</label>
                                <div class="col-sm-8">
                                    <input type="text" value="<?= $cliente['nombre_factura']; ?>" name="factura_cliente" id="factura_cliente" class="form-control text-uppercase" autocomplete="off" data-validation="required letternumber length" data-validation-allowing="-+./&() " data-validation-length="max100" readonly>
                                </div>
                            </div>
    						<div class="form-group">
    							<label for="telefono_cliente" class="col-sm-4 control-label">Teléfono:</label>
    							<div class="col-sm-8">
    								<input type="text" value="<?= $cliente['telefono']; ?>" name="telefono_cliente" id="telefono_cliente" class="form-control text-uppercase" autocomplete="off" data-validation="required" data-validation-length="max100" readonly>
    							</div>
    						</div>
                            <div class="form-group">
                                <label for="atencion" class="col-sm-4 control-label">Ubicación:</label>
                                <div class="col-sm-8">
                                    <input type="text" value="<?= $cliente['ubicacion']; ?>" name="atencion" id="atencion" class="form-control text-uppercase" autocomplete="off" data-validation="required letternumber length" data-validation-allowing='-+/.,:;@#&"()_\n ' data-validation-length="max100" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="direccion" class="col-sm-4 control-label">Dirección:</label>
                                <div class="col-sm-8">
                                    <textarea name="direccion" id="direccion" class="form-control text-uppercase" rows="3" autocomplete="off" data-validation="letternumber" data-validation-allowing='-+/.,:;@#&"()_\n ' data-validation-optional="true" readonly><?= $cliente['direccion']; ?></textarea>
                                </div>
                            </div>
    		...
    		<div class="panel panel-default">
    			...
    			<div class="panel-body">
    				...
    				<div class="form-group">
    					...
    					<div class="col-sm-8">
    						<input type="number" value="<?= $cliente['dias']; ?>" step="1" name="dias" id="dias" max="365" maxlenght="3" id="dias" class="form-control" data-validation="required number" data-validation-length="max3">
    					</div>
    				</div>
