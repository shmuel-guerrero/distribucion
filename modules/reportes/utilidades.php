	...
	<table id="table" class="table table-bordered table-condensed table-striped table-hover table-xs">
		...
		<tbody>
			...
			foreach ($vventas as $nro3 => $vventa) { 
				...
				$detalle.="<tr><td>".$vventa['cantidadXprecio']."</td><td><b>".$vventa['unidad']."</b> "." de ".$vventa['precio']." ".$moneda."</td><td>".number_format($subtotal, 2, '.',' ')." ".$moneda."</td></tr>";
			}
...
$(function () {
	...
	var table = $('#table').on('draw.dt', function () { // search.dt order.dt page.dt length.dt
		...
		$('#preciototal').text(suma1.toFixed(2));
