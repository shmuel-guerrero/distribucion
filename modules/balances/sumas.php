    ...
    <div class="col-sm-8 col-sm-offset-2">
        ...
        <div class="table-responsive">
            ...
            <table class="table">
                ...
                <tr class="osc"><th>Nro</th><th>Cuentas</th><th>Debe</th><th>Haber</th><th>Deudor</th><th>Acreedor</th></tr>
                ...
                <tr>
                    ...
                    <td class="der">
                        <?php if($ac['SUM(a.debe)']>$ac['SUM(a.haber)']){echo convercion($ac['SUM(a.debe)']-$ac['SUM(a.haber)'],1,$db);$deu=$deu+$ac['SUM(a.debe)']-$ac['SUM(a.haber)'];}//else{echo number_format(0,2);} ?></td>
                    <td class="der">
                        <?php if($ac['SUM(a.debe)']<$ac['SUM(a.haber)']){echo convercion($ac['SUM(a.haber)']-$ac['SUM(a.debe)'],1,$db);$acr=$acr-$ac['SUM(a.debe)']+$ac['SUM(a.haber)'];}//else{echo number_format(0,2);} ?></td>
                </tr>
                <?php } ?>
                <tr>
                    <th colspan="2"></th>
                    <th class="der borde1"><?= convercion($deb,1,$db) ?></th>
                    <th class="der borde1"><?= convercion($hab,1,$db) ?></th>
                    <th class="der borde1"><?= convercion($deu,1,$db) ?></th>
                    <th class="der borde1"><?= convercion($acr,1,$db) ?></th>
                </tr>
            </table>
