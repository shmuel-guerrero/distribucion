...
<div class="panel-body">
	...
	<div class="row">
		<div class="col-sm-8 hidden-xs">
			<div class="text-label">Para agregar nuevas cajas hacer clic en el siguiente botón: </div>
		</div>
		<div class="col-xs-12 col-sm-4 text-right">
			...
			<a href="?/materiales/crear" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i><span> Nuevo</span></a>
			<?php } ?>
		</div>
	</div>
	<hr>
	...
	<table id="table" class="table table-bordered table-condensed table-restructured table-striped table-hover">
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-nowrap"><?= escape($material['nombre']); ?></td>
				...
				<td class="text-nowrap">
					<?php if ($permiso_ver) { ?>
					<a href="?/materiales/ver/<?= $material['id_materiales']; ?>" data-toggle="tooltip" data-title="Ver unidad"><i class="glyphicon glyphicon-search"></i></a>
					<?php } ?>
					<?php if ($permiso_editar) { ?>
					<a href="?/materiales/editar/<?= $material['id_materiales']; ?>" data-toggle="tooltip" data-title="Editar unidad"><i class="glyphicon glyphicon-edit"></i></a>
					<?php } ?>
					<?php if ($permiso_eliminar) { ?>
					<a href="?/materiales/eliminar/<?= $material['id_materiales']; ?>" data-toggle="tooltip" data-title="Eliminar unidad" data-eliminar="true"><i class="glyphicon glyphicon-trash"></i></a>
					<?php } ?>
				</td>
				<?php } ?>
			</tr>
	...
	<div class="alert alert-danger">
		...
		<p>No existen cajas registradas en la base de datos, para crear nuevas materiales hacer clic en el botón nuevo o presionar las teclas <kbd>alt + n</kbd>.</p>
	</div>
	<?php } ?>
</div>
