	...
	<div class="col-md-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
                ...
                <p class="text-right">
                    <a href="?/promociones/reporte_promos_monto" class="btn btn-warning">Promociones</a>
                </p>
                <?php endif ?>
				...
				$almacen = $db->from('inv_almacenes')->fetch();
					...
					?>
					<div class="col-md-4">
						<a class="seleccionarAlmacen" href="?/promociones/promocion_x_fecha/<?php echo $almacenX["id_almacen"]; ?>">
							<div class="panel panel-default">
							<div class="panel-heading">
