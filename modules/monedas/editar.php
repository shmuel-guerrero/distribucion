...
<div class="panel-body">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-5 col-md-6 text-right">
			...
			<?php } ?>
			<?php if ($permiso_ver) { ?>
			<a href="?/monedas/ver/<?= $moneda['id_moneda']; ?>" class="btn btn-warning"><i class="glyphicon glyphicon-search"></i><span class="hidden-xs hidden-sm"> Ver</span></a>
			<?php } ?>
			...
			<a href="?/monedas/listar" class="btn btn-primary"><i class="glyphicon glyphicon-list-alt"></i><span class="hidden-xs"> Listado</span></a>
			<?php } ?>
		</div>
	</div>
	<hr>
			...
			<form method="post" action="?/monedas/guardar" class="form-horizontal">
				<div class="form-group">
					...
					<div class="col-md-9">
						...
						<input type="text" value="<?= $moneda['moneda']; ?>" name="moneda" id="moneda" class="form-control" autocomplete="off" data-validation="required letter length" data-validation-allowing="() " data-validation-length="max100" maxlength="100">
					</div>
				</div>
				<div class="form-group">
					<label for="sigla" class="col-md-3 control-label">Sigla:</label>
					<div class="col-md-9">
						<input type="text" value="<?= $moneda['sigla']; ?>" name="sigla" id="sigla" class="form-control" autocomplete="off" data-validation="required letter length" data-validation-allowing=". " data-validation-length="max10" maxlength="10">
					</div>
				</div>
				<div class="form-group">
