	...
	<?php if ($permiso_cambiar || $permiso_crear || $permiso_imprimir) { ?>
		<div class="row">
			...
			<div class="col-xs-12 col-sm-4 text-right">
				...
				<?php } ?>
				<?php if ($permiso_libro_compra && validar_atributo($db, $_plansistema['plan'], module, file, 'libro_compras')) { ?>
				...
				<?php if ($permiso_crear) { ?>
					<a href="?/ingresos/seleccionar_almacen" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Nuevo Ingreso (Alt+N)"><span class="glyphicon glyphicon-plus"></span><span class="hidden-xs"> Ingresar</span></a>
				<?php } ?>
			</div>
		</div>
		<hr>
			...
			<tbody>
				<?php foreach ($ingresos as $nro => $ingreso) { ?>
					<tr>
						...
						<td class="text-nowrap"><?php if ($ingreso['transitorio'] != 0) { ?><a href="?/ingresos/activar/<?= $ingreso['id_ingreso']; ?>" class="label label-danger" data-toggle="tooltip" data-title="Cambiar estado" data-activar="true"><?php if ($ingreso['transitorio'] == 1) {
																																																															echo 'No esta en inventario';
																																																														} ?></a><?php } else { ?><span class="label label-success">En inventario</span> <?php } ?></td>
						...
						<?php if ($permiso_ver || $permiso_eliminar) { ?>
							<td class="text-nowrap">
								...
								<?php } ?>
								<?php if ($permiso_editar && $ingreso['tipo'] != 'Traspaso') {
									$pagado = $db->query("SELECT COUNT(id_pago) as pagado FROM inv_pagos p LEFT JOIN inv_pagos_detalles d ON p.id_pago = d.pago_id WHERE p.tipo = 'Ingreso' AND p.movimiento_id = " . $ingreso['id_ingreso'] . " AND d.estado = 1")->fetch_first();
									if ($pagado['pagado'] < 2) { ?>
										<a href="?/ingresos/editar/<?= $ingreso['id_ingreso']; ?>" data-toggle="tooltip" data-title="Editar ingreso"><span class="glyphicon glyphicon-edit"></span></a>
								<?php  	}
								} ?>
								<?php if ($permiso_eliminar) { ?>
									<a href="?/ingresos/eliminar/<?= $ingreso['id_ingreso']; ?>" class="danger" data-toggle="tooltip" data-title="Eliminar ingreso" data-eliminar="true"><span class="glyphicon glyphicon-trash"></span></a>
								<?php } ?>
							</td>
						<?php } ?>
					</tr>
