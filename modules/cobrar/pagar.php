...
<div class="panel-body">
				...
				<div class="panel-body">
					<div class="form-horizontal">
						<div class="form-group">
							...
							<div class="col-md-9">
								<p class="form-control-static"><?= escape($ingreso['nombre_cliente']); ?></p>
							</div>
						</div>
						<div class="form-group">
	...
	<div class="row">
		<div class="col-sm-8 col-sm-offset-2">
			<form method="POST" action="?/cobrar/guardar_plan_pagos" class="form-horizontal" autocomplete="off">
	
				<input type="hidden" name="ip" value="<?= $ingreso['id_egreso']; ?>">
