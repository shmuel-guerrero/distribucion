	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-4 text-right">
			...
			<?php if ($permiso_crear) { ?>
				<a href="?/proformas/crear" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span><span class="hidden-xs"> Crear proforma</span></a>			
			<?php } ?>
		</div>
	</div>
	<hr>
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-nowrap">
					<?php if ($permiso_ver) { ?>
					<a href="?/proformas/ver/<?= $proforma['id_proforma']; ?>" data-toggle="tooltip" data-title="Ver detalle de la proforma"><i class="glyphicon glyphicon-list-alt"></i></a>
					<?php } ?>
					<?php if ($permiso_eliminar) { ?>
					<a href="?/proformas/eliminar/<?= $proforma['id_proforma']; ?>" data-toggle="tooltip" data-title="Eliminar proforma" data-eliminar="true"><span class="glyphicon glyphicon-trash"></span></a>
					<?php } ?>
				</td>
				<?php } ?>
			</tr>
