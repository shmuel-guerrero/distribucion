...
if (is_post()) {
	...
	if (isset($_POST['avatar']) && isset($_POST['avatar_x']) && isset($_POST['avatar_y']) && isset($_POST['avatar_w']) && isset($_POST['avatar_h'])) {
		...
		// Obtiene las rutas de las nuevas avatares
