...
$ingresos = $db->select('i.*,p.*,pd.*')->from('inv_ingresos i')
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-nowrap">
					...
					<a href="?/ingresos/eliminar/<?= $ingreso['id_ingreso']; ?>" data-toggle="tooltip" data-title="Eliminar ingreso" data-eliminar="true"><i class="glyphicon glyphicon-trash"></i></a>
					<?php } ?>
				</td>
				<?php } ?>
			</tr>
