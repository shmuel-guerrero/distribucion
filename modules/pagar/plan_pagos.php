...
<div class="panel-body">
	<div class="row">
		<div class="col-sm-8 hidden-xs">
			<div class="text-label">Para realizar un ingreso hacer clic en el siguiente bot√≥n: </div>
		</div>
	</div>
	<hr>
    	...
    	<table id="table" class="table table-bordered table-condensed table-striped table-hover table-xs">
    		...
    		<tfoot>
    			<tr class="active">
    				...
    				<th class="text-nowrap align-middle" data-datafilter-filter="true">Descripci√≥n</th>
...
function guardar(){
    // bootbox.confirm("Esta seguro de guardar los pagos?, esta acci®Æn no se puede rehacer!", function(result){ 
