...
<div class="panel-heading" data-formato="<?= strtoupper($formato_textual); ?>" data-mascara="<?= $formato_numeral; ?>" data-gestion="<?= date_decode($gestion_base, $_institution['formato']); ?>">
	<h3 class="panel-title">
		...
		<strong>Proformas de venta personal</strong>
	</h3>
</div>
<div class="panel-body">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-4 text-right">
			...
			<a href="?/preventas/crear" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span><span class="hidden-xs"> Proforma</span></a>
			<?php } ?>
		</div>
	</div>
	<hr>
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-nowrap">
					<?php if ($permiso_ver) { ?>
					<a href="?/preventas/ver/<?= $proforma['id_proforma']; ?>" data-toggle="tooltip" data-title="Ver detalle de la proforma"><i class="glyphicon glyphicon-list-alt"></i></a>
					<?php } ?>
					<?php if ($permiso_eliminar) { ?>
					<a href="?/preventas/eliminar/<?= $proforma['id_proforma']; ?>" data-toggle="tooltip" data-title="Eliminar proforma" data-eliminar="true"><span class="glyphicon glyphicon-trash"></span></a>
					<?php } ?>
				</td>
				<?php } ?>
			</tr>
...
$(function () {	
	...
	$.validate({
		...
		onSuccess: function () {
			...
			window.location = '?/preventas/mostrar' + inicial_fecha + final_fecha;
		}
	});
