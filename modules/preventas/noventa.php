			...
			<div class="panel-body">
				...
				<form id="formulario" class="form-horizontal">
					<div style="zoom: 1;">
                        ...
                        <div class="form-group">
                            <label for="observacion" class="col-sm-4 control-label">Dirección:</label>
                            <div class="col-sm-8">
	...
	<div class="col-md-6">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<p class="text-right">
					<a href="?/operaciones/proformas_listar" class="btn btn-success">Mis Preventas</a>
				</p>
				<?php endif ?>
...
if (Geolocalizacion) Geolocalizacion.getCurrentPosition(mostrarUbicacion, Excepciones);
