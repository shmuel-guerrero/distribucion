...
define('ATENCION', 'Atención: '.'Lun. a Vie. de 08:30 a 18:30 y Sáb. de 08:30 a 13:00');
...
EOD;
	...
	$valor_descuento_global = number_format(escape($egreso['descuento_bs']), 2, '.', '');	
	$valor_moneda = $moneda;
	$total = 0;
	
	$valor_descuento_porcentaje  = ($egreso['descuento_porcentaje'] != 0 ? ' ('.$egreso['descuento_porcentaje'].'%)' : '');
	...
	<table cellpadding="5">
		<tr>
			...
			<th width="43%" class="all" align="center">NOMBRE</th>
			<th width="16%" class="all" align="center">CANTIDAD</th>
		...
		$body
		<tr>
			<th class="all" align="right" colspan="5">SUBTOTAL $valor_moneda: </th>
			<th class="all" align="right">$valor_monto_total</th>
		</tr>
		<tr>
			<th class="all" align="right" colspan="5">DESCUENTO $valor_moneda $valor_descuento_porcentaje: </th>
			<th class="all" align="right">$valor_descuento_global</th>
		</tr>
		<tr>
			<th class="all" align="right" colspan="5">IMPORTE TOTAL $valor_moneda</th>
			<th class="all" align="right">$valor_monto_total_descuento</th>
		</tr>
		<!-- <tr>
