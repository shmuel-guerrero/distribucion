...
$permiso_imprimir = false; //in_array('proformas_imprimir', $permisos);
$permiso_facturar = false; //in_array('proformas_facturar', $permisos);
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-4 text-right">
			...
			<?php if ($permiso_crear) { ?>            
				<a href="?/preventas/crear" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span><span class="hidden-xs hidden-sm"> Crear preventa</span></a>			
            <?php } ?>
		</div>
	</div>
	<hr>
