...
$empleados = $db->query("SELECT b.*, GROUP_CONCAT(c.distribuidor_estado,'-',c.monto_total SEPARATOR '|') AS entregas  FROM sys_users a
                    ...
                    <tr>
                        ...
                        <?php if ($permiso_ver || $permiso_editar || $permiso_eliminar) { ?>
                            <td class="text-nowrap">
                                <?php if ($permiso_ver) { ?>
                                    <a href="?/distribuidor/ver4/<?= $empleado['id_empleado']; ?>/<?= $fecha_inicial; ?>/<?= $fecha_final; ?>" data-toggle="tooltip" data-title="Ver ruta"><i class="glyphicon glyphicon-search"></i></a>
                                <?php } ?>
        ...
        $(function () {
            ...
            $.validate({
                ...
                onSuccess: function () {
                    ...
                    window.location = '?/distribuidor/listar3' + inicial_fecha + final_fecha;
                }
            });
