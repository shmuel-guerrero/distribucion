...
// Formateamos la tabla
	...
	<table cellpadding="5" style="border:1px solid black;">
        <tr>
            <td width="10%" bgcolor="#a1a1a1" align="center" style="border-bottom:1px solid black;"><h2><font color="#ffffff"><em>OBS</em></font></h2></td>
            <td width="65%" bgcolor="#a1a1a1" style="border-bottom:1px solid black;">$detalle_venta</td>
            <td width="15%" bgcolor="#a1a1a1" style="border-bottom:1px solid black;" align="right"><font color="#ffffff">SUBTOTAL</font></td>
            <td width="10%">$valor_total</td>
        </tr>
        <tr>
            <td width="10%" rowspan="2" bgcolor="#a1a1a1" align="center" vertical-align="center" style="border-bottom:1px solid black;border-right:1px solid black;"><h1><font color="#ffffff">$nro_nota</font></h1></td>
            <td width="65%" bgcolor="#a1a1a1" style="border-bottom:1px solid black;">&nbsp;</td>
            <td width="15%" bgcolor="#a1a1a1" style="border-bottom:1px solid black; border-bottom:1px solid black;" align="right"><font color="#ffffff">DESCUENTO</font></td>
            <td width="10%" style="border-bottom:1px solid black;border-top:1px solid black;">$valor_descuento</td>
        </tr>
        <tr>
