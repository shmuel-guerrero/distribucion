...
// Define las variables
    ...
    $valor_nombre_cliente = ($egreso['nombre_factura'] != '' && $egreso['nombre_factura'] != null) ? escape($egreso['nombre_factura']) : escape($egreso['nombre_cliente']);
