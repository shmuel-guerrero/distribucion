...
//                                        var_dump($ruta);
                                        ...
                                        $egresos = $db->select(' SUM(b.monto_total) as total, count(b.id_egreso) as registros')
                                            ->from('sys_empleados a')->join('inv_egresos b','a.id_empleado = b.empleado_id')
                                            ->where('b.estadoe',2)->where('b.grupo','')->where('b.fecha_entrega','0000-00-00')->where('b.fecha_egreso<=',$fecha)->where('b.ruta_id',$emp[$c])->fetch_first();
//                                        echo $db->last_query();
//                                        var_dump($egresos);
//                                        var_dump($emp[$c]);
                        ...
                        <?php if ($permiso_ver || $permiso_editar || $permiso_eliminar) { ?>
                            <td class="text-nowrap">
                                <?php if ($permiso_ver) { ?>
                                    <a href="?/distribuidor/visitas/<?= $empleado['id_empleado']; ?>/<?= $fecha_inicial; ?>/<?= $fecha_final; ?>" data-toggle="tooltip" data-title="Ver ruta"><i class="glyphicon glyphicon-search"></i></a>
                                <?php } ?>
                                <?php if ($permiso_ver2) { ?>
                                    <a href="?/distribuidor/ver2/<?= $empleado['id_empleado']; ?>/<?= $fecha_inicial; ?>/<?= $fecha_final; ?>" data-toggle="tooltip" data-title="Hoja salida" ><i class="glyphicon glyphicon-list-alt"></i></a>
                                <?php } ?>
                                <?php if ($permiso_imprimir) { ?>
                                    <a href="?/distribuidor/imprimir2/<?= $empleado['id_empleado']; ?>/<?= $fecha_inicial ?>/<?= $fecha_final ?>" target="_blank" data-toggle="tooltip" data-title="Hoja salida" ><i class="glyphicon glyphicon-print"></i></a>
                                    <button type="button" onclick="imprimir(<?= $empleado['id_empleado']; ?>)" data-toggle="tooltip" data-title="Imprimir ventas"><i class="glyphicon glyphicon-list"></i></button>
                                    <!--                                    <a href="?/distribuidor/imprimir1_termico/--><?//= $empleado['id_empleado']; ?><!--" target="_blank" data-title="Imprimir ventas" ><i class="glyphicon glyphicon-list"></i></a>-->
                                <?php } ?>
                                <?php if ($permiso_activar) { ?>
                                    <?php if ($empleado['fecha'] != date('Y-m-d')) { ?>
                                        <a href="?/distribuidor/activar2/<?= $empleado['id_empleado']; ?>" class="text-info" data-toggle="tooltip" data-title="Cerrar distribucion" data-activar="true"><i class="glyphicon glyphicon-unchecked"></i></a>
                                        <a href="?/distribuidor/activar/<?= $empleado['id_empleado']; ?>" class="text-danger" data-toggle="tooltip" data-title="Cerrar distribucion (limpiar)" data-activar="true"><i class="glyphicon glyphicon-unchecked"></i></a>
                                    <?php } else { ?>
                                        <a href="?/distribuidor/imprimir3/<?= $empleado['id_empleado']; ?>" class="text-success" target="_blank" data-toggle="tooltip" data-title="Imprimir liquidación" ><i class="glyphicon glyphicon-print"></i></a>  
                                        <a href="?/distribuidor/activar3/<?= $empleado['id_empleado']; ?>" class="text-success" data-toggle="tooltip" data-title="Entrega realizada"><i class="glyphicon glyphicon-check"></i></a>
