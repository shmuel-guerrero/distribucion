...
// Obtiene las ventas
$proformas = $db->select('i.*, a.almacen, a.principal, e.nombres, e.paterno, e.materno')->from('inv_egresos i')->join('inv_almacenes a', 'i.almacen_id = a.id_almacen', 'left')->join('sys_empleados e', 'i.empleado_id = e.id_empleado', 'left')->where('i.fecha_egreso >= ', $fecha_inicial)->where('i.fecha_egreso <= ', $fecha_final)->where('i.estadoe',1)->where('i.estadoe!=',2)->order_by('i.fecha_egreso desc, i.hora_egreso desc')->fetch();
                                    ...
                                    <td class="text-nowrap">
                                        ...
                                        <?php if ($permiso_imprimir) {
                                            if($proforma['estadoe']==1){?>
                                                <a href="?/distribuidor/imprimir/<?= $proforma['id_egreso']; ?>" data-toggle="tooltip" data-title="Imprimir" data-eliminar="true"><span class="glyphicon glyphicon-print" style="color:green"></span></a>
                                            <?php } if($proforma['estadoe']==2){?>
                                                <a href="?/distribuidor/imprimir/<?= $proforma['id_egreso']; ?>" data-toggle="tooltip" data-title="Imprimir" data-eliminar="true"><span class="glyphicon glyphicon-print" style="color:red"></span></a>
                                            <?php }if($proforma['estadoe']==3){ ?>
                                                <a href="?/distribuidor/imprimir/<?= $proforma['id_egreso']; ?>" data-toggle="tooltip" data-title="Imprimir" data-eliminar="true"><span class="glyphicon glyphicon-print" style="color:blue"></span></a>
                                            <?php    }} ?>
                                    </td>
                                <?php } ?>
                            </tr>
        ...
        $(function () {
            ...
            $.validate({
                ...
                onSuccess: function () {
                    ...
                    window.location = '?/distribuidor/visitas' + inicial_fecha + final_fecha;
                }
            });
