...
<div class="panel-body">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-4 text-right">
			...
			<a href="?/usuarios/crear" class="btn btn-primary"data-toggle="tooltip" data-placement="top" title="Nuevo Usuario (Alt+N)"><i class="glyphicon glyphicon-plus"></i><span> Nuevo</span></a>
			<?php } ?>
		</div>
	</div>
	<hr>
