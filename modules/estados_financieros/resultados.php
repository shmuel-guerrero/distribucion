        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-4 text-right">
                <?php if ($permiso_imprimir) { ?>
                    <a href="?/estados_financieros/imprimir_resultados" target="_blank" class="btn btn-info"><span class="glyphicon glyphicon-print"></span><span class="hidden-xs"> Imprimir</span></a>
                <?php } ?>
