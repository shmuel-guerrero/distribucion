		...
		<div class="col-sm-8 col-sm-offset-2">
			<form method="post" action="?/movimientos/ingresos_guardar" class="form-horizontal">
				<div class="form-group">
					...
					<div class="col-md-9">
						<input type="text" value="<?= date_decode($ingreso['fecha_movimiento'], $_institution['formato']); ?>" name="fecha_movimiento" id="fecha_movimiento" class="form-control" autocomplete="off" data-validation="required date" data-validation-format="<?= $formato_textual; ?>">
					</div>
				</div>
				<div class="form-group">
					<label for="hora_movimiento" class="col-md-3 control-label">Hora:</label>
					<div class="col-md-9">
						<input type="text" value="<?= $ingreso['hora_movimiento']; ?>" name="hora_movimiento" id="hora_movimiento" class="form-control" autocomplete="off" data-validation="required alphanumeric length" data-validation-allowing=":" data-validation-length="8">
					</div>
				</div>
				<div class="form-group">
					<label for="nro_comprobante" class="col-md-3 control-label">Número de comprobante:</label>
					<div class="col-md-9">
						<input type="hidden" value="<?= $ingreso['id_movimiento']; ?>" name="id_movimiento" data-validation="required">
						<input type="text" value="<?= $ingreso['nro_comprobante']; ?>" name="nro_comprobante" id="nro_comprobante" class="form-control" autocomplete="off" data-validation="required letternumber" data-validation-allowing="+-/#() ">
					</div>
				</div>
				<div class="form-group">
					<label for="concepto" class="col-md-3 control-label">Por concepto de:</label>
					<div class="col-md-9">
						<textarea name="concepto" id="concepto" class="form-control" autocomplete="off" data-validation="required letternumber" data-validation-allowing="+-/.,:;#()\n "><?= $ingreso['concepto']; ?></textarea>
					</div>
				</div>
				<div class="form-group">
					<label for="monto" class="col-md-3 control-label">Monto <?= $moneda; ?>:</label>
					<div class="col-md-9">
						<input type="text" value="<?= $ingreso['monto']; ?>" name="monto" id="monto" class="form-control" autocomplete="off" data-validation="required number" data-validation-allowing="float">
					</div>
				</div>
				<div class="form-group">
					<label for="observacion" class="col-md-3 control-label">Observacion:</label>
					<div class="col-md-9">
						<textarea name="observacion" id="observacion" class="form-control" autocomplete="off" data-validation="letternumber" data-validation-allowing="+-/.,:;#()\n " data-validation-optional="true"><?= $ingreso['observacion']; ?></textarea>
					</div>
				</div>
				<div class="form-group">
