...
// Obtiene el gasto
$movimiento = $db->query("SELECT m.*, ifnull(concat( e.nombres, ' ', e.paterno, ' ', e.materno ), '-') as nombre_autorizado_por, ifnull(concat( er.nombres, ' ', er.paterno, ' ', er.materno ), '-') as nombre_recibido_por
