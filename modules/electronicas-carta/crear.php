				...
				<form id="formulario" class="form-horizontal">
					...
					<div class="table-responsive margin-none">
						<table id="ventas" class="table table-bordered table-condensed table-striped table-hover margin-none">
							<thead>
								<tr class="active">
									<th class="text-nowrap text-middle text-center width-collapse">#</th>
									<th class="text-nowrap text-middle text-center width-collapse">Código</th>
									<th class="text-nowrap text-middle text-center">Producto</th>
									<th class="text-nowrap text-middle text-center width-collapse">Cantidad</th>
									<th class="text-nowrap text-middle text-center width-collapse">Precio</th>
									<th class="text-nowrap text-middle text-center width-collapse">Descuento</th>
									<th class="text-nowrap text-middle text-center width-collapse">Importe</th>
									<th class="text-nowrap text-middle text-center width-collapse">Acciones</th>
								</tr>
							</thead>
							<tfoot>
								<tr class="active">
									<th class="text-nowrap text-right" colspan="6">Importe total</th>
	...
	<div class="col-md-6">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<?php endif ?>
				<form method="post" action="?/electronicas/buscar" id="form_filtrar" class="margin-bottom" autocomplete="off">
					<div class="form-group has-feedback">
						<input type="text" value="" name="busqueda" class="form-control" autofocus="autofocus" placeholder="Buscar por código, producto, categoría o precio">
...
<div id="tabla_filtrar" class="hidden">
	<div class="table-responsive">
		<table class="table table-bordered table-condensed table-striped table-hover">
			<thead>
				<tr class="active">
					<th class="text-nowrap text-middle text-center width-collapse">Imagen</th>
					<th class="text-nowrap text-middle text-center width-collapse">Código</th>
					<th class="text-nowrap text-middle text-center">Producto</th>
					<th class="text-nowrap text-middle text-center width-collapse">Categoría</th>
					<th class="text-nowrap text-middle text-center width-collapse">Stock</th>
					<th class="text-nowrap text-middle text-center width-collapse">Precio</th>
					<th class="text-nowrap text-middle text-center width-collapse">Acciones</th>
				</tr>
			</thead>
...
$(function () {
	...
	var $form_filtrar = $('#form_filtrar'), $contenido_filtrar = $('#contenido_filtrar'), $tabla_filtrar = $('#tabla_filtrar'), $fila_filtrar = $('#fila_filtrar'), $mensaje_filtrar = $('#mensaje_filtrar'), $modal_mostrar = $('#modal_mostrar'), $loader_mostrar = $('#loader_mostrar');
