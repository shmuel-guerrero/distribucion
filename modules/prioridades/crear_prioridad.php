...
$tipos = $db->select('*')->from('inv_prioridades_ventas')->fetch();
...
<div class="panel-heading">
	<h3 class="panel-title">
		...
		<strong>Crear prioridades</strong>
	</h3>
</div>
<div class="panel-body">
	...
	<div class="row">
			...
			<table id="table" class="table table-bordered table-condensed table-restructured table-striped table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td class="text-nowrap"><?= escape($tipo['prioridad']); ?></td>
		                <td class="text-nowrap">
	                        <a href="?/prioridades/eliminar_prioridad/<?= $tipo['id_prioridad_venta']; ?>" data-toggle="tooltip" data-title="Eliminar prioridad" data-eliminar="true"><span class="glyphicon glyphicon-trash"></span></a>
						</td>
					</tr>
					<?php } ?>
				</tbody>
		...
		<div class="col-sm-6">
			<form method="post" action="?/prioridades/guardar_prioridad" class="form-horizontal" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="tipo" class="col-md-3 control-label">Prioridad:</label>
                    <div class="col-md-9">
