...
foreach ($detalles as $nro => $detalle) {
	...
	$body .= '<td width="52%" align="justify"><b>' . escape($detalle['nombre']) . '</b><br><em>' . str_replace("\n", '<br>', $detalle['descripcion']) . '</em></td>';
...
$pdf->Cell($width_page * 0.24, $height_cell * 1.5, number_format($total, 2, '.', ','), 0, 1, 'R', 0, '', 1, true, 'T', 'M');
