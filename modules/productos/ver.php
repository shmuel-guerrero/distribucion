...
// Obtiene el producto
$producto = $db->select('z.*, a.unidad, a.sigla, b.categoria, m.marca')->from('inv_productos z')->join('inv_unidades a', 'z.unidad_id = a.id_unidad', 'left')->join('inv_categorias b', 'z.categoria_id = b.id_categoria', 'left')->join('inv_marcas m', 'z.marca_id = m.id_marca', 'left')->where('z.id_producto', $id_producto)->fetch_first();
			...
			<div class="well">
				...
				<div class="table-display" data-print-data="true">
					<div class="tbody">
                        ...
                        <div class="tr">
                            <div class="th text-nowrap">Marca:</div>
                            <div class="td">
                                <span><?= ($producto['marca']) ? escape($producto['marca']) : 'S/M'; ?></span>
                            </div>
                        </div>
						<div class="tr">
...
$(function () {
	...
	$('#impresion').on('submit', function (e) {
		...
		if ($.isNumeric(cantidad) && cantidad > 0 && cantidad < 10000) {
			...
			$(this).find(':text').val('');
			bootbox.alert('La información enviada debe ser de tipo numérico (mayor que 0 y menor que 10000)');
		}
	});
