			...
			<form method="post" id="myform" action="?/productos/guardar" class="form-horizontal" autocomplete="off">
				<div class="form-group">
					...
					<div class="col-md-9">
						...
						<input type="text" value="<?= $producto['codigo']; ?>" name="codigo" id="codigo" class="form-control" data-validation-allowing="-/.#º() " data-validation-length="max50">
					</div>
				</div>
                <div class="form-group">
				...
				<div class="form-group hidden">
					<label for="categoria_id" class="col-md-3 control-label">Marca:</label>
					<div class="col-md-9">
						<select name="marca_id" id="marca_id" class="form-control" data-validation="required">
							<option value="">Seleccionar</option>
							<?php foreach ($marcas as $elemento) { ?>
								<?php if ($elemento['id_marca'] == $producto['marca_id']) { ?>
								<option value="<?= $elemento['id_marca']; ?>" selected><?= escape($elemento['marca']); ?></option>
								<?php } else { ?>
