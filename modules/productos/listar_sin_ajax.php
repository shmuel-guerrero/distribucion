		...
		<tbody>
			...
			<tr class="<?php if($producto['promocion'] == 'si'){ echo 'warning';} ?>" >
                ...
                <td class="text-nowrap text-middle text-right" ><?php
                    $ids_asignaciones = $db->select('*')->from('inv_asignaciones a')->join('inv_unidades b','a.unidad_id = b.id_unidad  AND a.visible = "s" ' )->where('a.producto_id',$producto['id_producto'])->fetch();?>
