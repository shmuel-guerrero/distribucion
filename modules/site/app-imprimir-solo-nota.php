...
if (is_post()) {
    ...
    if (isset($_POST['id_cliente'])) {
        ...
        $empleado = ($empleado['empleado']) ? $empleado['empleado'] : 0;
        ...
        $descuento1 = array();
        $subtotales = array();
        $venta_t = round($venta['monto_total'] ,2, PHP_ROUND_HALF_UP);
        if($venta['monto_total_descuento'] > 0){
            $venta_tt = $venta['monto_total_descuento'];
        }else{
            $venta_tt = $venta['monto_total'];
        }
        $venta_t = $venta['monto_total'];
        $descuento_t = $venta['descuento_bs'];
