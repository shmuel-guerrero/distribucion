...
//                                        if($detalle['prec']){?>
                                        ...
                                        <?php }else{ ?>
                                            <td><input type="text" value="<?= nombre_unidad($db,$detalle['unidad_det']); ?>" name="unidad[]" class="form-control input-xs text-middle text-lefth" autocomplete="off" data-unidad="<?= $detalle['unidad_det'] ?>" readonly data-validation-error-msg="Debe ser un número decimal positivo"></td>
                                        <?php } ?>
					...
					<div id="credito_cliente">
					    <p class="text-info" id="cred">
					        ...
					        //     echo '<div class="alert alert-info" id="borrar"> <b>Forma de pago: </b> El cliente tiene un contrato de créditos de: '.$proforma['dias']. ' días.  </div>';
					        // } else {
		...
		<div class='row'>
			<div class='col-md-12'> <!-- col-sm-10 col-sm-offset-1 -->
				<div class='panel panel-success'>
					<div class='panel-heading'>
						<h3 class='panel-title'><i class='glyphicon glyphicon-log-out'></i> Información de la proforma</h3>
					</div>
					<div class='panel-body'>
						<div class='form-horizontal'>
							...
							<div class='form-group'>
								<label class='col-md-3 control-label'>Número de proforma:</label>
								<div class='col-md-9'>
    ...
    function adicionar_producto(id_producto) {		
		...
		if ($producto.size()) {
			...
			plantilla = '<tr class="active" data-producto="' + id_producto + '">' +
						...
						'<td class="text-nowrap input-xs text-middle"><input type="text" value="' + id_producto + '" name="productos[]" class="translate" tabindex="-1" data-validation="required number" data-validation-error-msg="Debe ser número">' + codigo + '</td>' +
						...
						'<td class="text-nowrap input-xs text-middle"><input type="text" value="1" name="cantidades[]" data-cantidad="" class="form-control input-xs text-right" maxlength="10" autocomplete="off" data-validation="required number" data-validation-allowing="range[1;1000000]" data-validation-error-msg="Debe ingresar un número positivo entre 1 y 1000000" onkeyup="calcular_importe(' + id_producto + ')"></td>';
						// data-validation="required number" data-validation-allowing="range[1;' + stock + ']" data-validation-error-msg="Debe ser un número positivo entre 1 y ' + stock + '"
			if(porciones.length>2){
				...
				plantilla = plantilla + '<td><input type="text" value="' + parte[0] + '" data-xyyz="' +stock+ '" name="unidad[]" class="form-control input-xs text-middle text-lefth" autocomplete="off" data-unidad="' + parte[0] + '" data-validation-error-msg="Debe ser un número decimal positivo" readonly></td>'+
