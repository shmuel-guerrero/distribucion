	...
	<thead>
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-nowrap text-center"><?= ($estadoAnulado ? '<span class="text-info"><b>Activo</b></span>' : '<span class="text-danger"><b>Anulado</b></span>'); ?></td>
                    <td class="text-nowrap">
                        ...
                        <?php if ($permiso_eliminar) { ?>
                            <a href="?/operaciones/manuales_eliminar/<?= $venta['id_egreso']; ?>" data-toggle="tooltip"  style="margin-right: 5px" data-title="Eliminar venta" data-eliminar="true"><i class="glyphicon glyphicon-trash"></i></a>
                        <?php } ?>
						...
						<?php if ($permiso_anular && date('Y-m-d') <= $masUnMesdate) { ?>
                            <a href="?/operaciones/activar_manuales/<?= $venta['id_egreso']; ?>" data-toggle="tooltip"  style="margin-right: 5px" data-title="<?= $estadoAnulado ? 'Anular' : 'Activar'?> (puede <?= $estadoAnulado ? 'anular' : 'activar'?> venta hasta el <?= $masUnMesdate; ?>)."><i class="text-<?= $estadoAnulado ? 'info' : 'danger'?> glyphicon glyphicon-<?= $estadoAnulado ? 'remove-circle' : 'ok-circle'?>"></i></a>
                        <?php } ?>
                    </td>
			</tr>
			<?php } ?>
