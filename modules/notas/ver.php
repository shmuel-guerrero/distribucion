...
<div class="panel-body">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-5 col-md-6 text-right">
			...
			<a href="?/notas/mostrar" class="btn btn-primary"><span class="glyphicon glyphicon-list-alt"></span><span class="hidden-xs hidden-sm hidden-md"> Listado de mis notas de remisión</span></a>
			<?php } ?>
		</div>
	</div>
	<hr>
