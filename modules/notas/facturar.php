...
<div class="row">
	...
	<div class="col-md-6">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="row">
					<div class="col-xs-12 text-right">
						<a href="?/notas/mostrar" class="btn btn-primary">
				<span class="glyphicon glyphicon-list-alt"></span>
				<span>Ventas personales</span></a>
					</div>
				</div>
				<hr>
				<?php } ?>
	...
	<div class="col-xs-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title"><span class="glyphicon glyphicon-home"></span> Ventas electrónicas</h3>
			</div>
			<div class="panel-body">
				<div class="alert alert-danger">
					<strong>Advertencia!</strong>
