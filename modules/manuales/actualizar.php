...
if (is_ajax()) {
	...
	if (isset($_POST['id_producto'])) {
		...
		// Obtiene el producto
		$producto = $db->query("select p.id_producto, p.precio_actual, ifnull(e.cantidad_ingresos, 0) as cantidad_ingresos, ifnull(s.cantidad_egresos, 0) as cantidad_egresos,u.unidad
								...
								left join inv_unidades AS u ON u.id_unidad=p.unidad_id
								where p.id_producto = $id_producto")->fetch_first();
