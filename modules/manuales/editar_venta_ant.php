...
$egreso2 = $db->select('*')->from('inv_egresos')->where('id_egreso', $id_venta)->fetch_first();
					...
					<div class="table-responsive margin-none">
						<table id="ventas" class="table table-bordered table-condensed table-striped table-hover table-xs margin-none">
                            ...
                            <?php foreach($detalle2 as $deta){ ?>
                                <tr class="active" data-producto="' + id_producto + '">
                                    <td class="text-nowrap"></td>
                                    <td class="text-nowrap"><input type="text" value="<?= $deta['id_producto'] ?>" name="productos[]" class="translate" tabindex="-1" data-validation="required number" data-validation-error-msg="Debe ser número"><?= $deta['codigo'] ?></td>
                                    <td><input type="text" value="<?= $deta['nombre'] ?>" name="nombres[]" class="translate" tabindex="-1" data-validation="required"><?= $deta['nombre'] ?></td>
                                    <td><input type="text" value="<?= $deta['cantidad'] ?>" name="cantidades[]" class="form-control input-xs text-right" maxlength="7" autocomplete="off" data-cantidad="" data-validation="required number" data-validation-error-msg="Debe ser un número positivo entre 1 y ' + stock + '" onkeyup="calcular_importe(<?= $deta['id_producto'] ?>)"></td>
                                    <td><input type="text" value="<?= $deta['precio'] ?>" name="precios[]" class="form-control input-xs text-right" autocomplete="off" data-precio="' + valor + '" data-validation="required number" readonly data-validation-allowing="range[0.01;1000000.00],float" data-validation-error-msg="Debe ser un número decimal positivo" onkeyup="calcular_importe(<?= $deta['id_producto'] ?>)"></td>
                                    <td><input type="text" value="0" name="descuentos[]" class="form-control input-xs text-right" maxlength="2" autocomplete="off" data-descuento="0" data-validation="required number" data-validation-allowing="range[0;50]" data-validation-error-msg="Debe ser un número positivo entre 0 y 50" onkeyup="descontar_precio(<?= $deta['id_producto'] ?>)"></td>
