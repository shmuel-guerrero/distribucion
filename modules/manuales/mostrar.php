...
// Obtiene las ventas
$ventas = $db->select('i.*, a.almacen, a.principal, e.nombres, e.paterno, e.materno')->from('inv_egresos i')->join('inv_almacenes a', 'i.almacen_id = a.id_almacen', 'left')->join('sys_empleados e', 'i.empleado_id = e.id_empleado', 'left')->where('i.empleado_id', $_user['persona_id'])->where('i.tipo', 'Venta')->where('i.nro_autorizacion!=', '')->where('i.fecha_egreso >= ', $fecha_inicial)->where('i.fecha_egreso <= ', $fecha_final)->order_by('i.fecha_egreso desc, i.hora_egreso desc')->fetch();
...
<div class="panel-heading" data-formato="<?= strtoupper($formato_textual); ?>" data-mascara="<?= $formato_numeral; ?>" data-gestion="<?= date_decode($gestion_base, $_institution['formato']); ?>">
	<h3 class="panel-title">
		...
		<strong>Ventas manuales personales</strong>
	</h3>
</div>
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-nowrap">
					<?php if ($permiso_ver) { ?>
					<a href="?/manuales/ver/<?= $venta['id_egreso']; ?>" data-toggle="tooltip" data-title="Ver detalle de venta"><i class="glyphicon glyphicon-list-alt"></i></a>
					<?php } ?>
					<?php if ($permiso_eliminar) { ?>
					<a href="?/manuales/eliminar/<?= $venta['id_egreso']; ?>" data-toggle="tooltip" data-title="Eliminar venta" data-eliminar="true"><span class="glyphicon glyphicon-trash"></span></a>
					<?php } ?>
				</td>
				<?php } ?>
			</tr>
...
$(function () {	
	...
	var table = $('#table').DataFilter({
		filter: true,
		name: 'ventas_manuales_personales',
