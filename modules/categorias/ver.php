...
<div class="panel-body">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-5 col-md-6 text-right">
			...
			<a href="?/categorias/editar/<?= $categoria['id_categoria']; ?>" class="btn btn-primary">
			...
			<a href="?/categorias/imprimir/<?= $categoria['id_categoria']; ?>" target="_blank" class="btn btn-info">
